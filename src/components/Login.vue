<template>
    <div class="login-vue" :style="bg">
        <div class="container">
            ...
            <Button :loading="isShowLoading" class="submit" type="primary" @click="tourist">游客模式</Button>
...
<script>
import loginImg from '../assets/imgs/binn.jpg'
...
export default {
    ...
    methods: {
        ...
        tourist() {
            localStorage.setItem('userImg', loginImg)
            localStorage.setItem('userName', 'binn')
            // 登陆成功 假设这里是后台返回的 token
            localStorage.setItem('token', 'i_am_token')
            this.$router.push({ path: this.redirect || '/tourist' })
        },
        submit() {
